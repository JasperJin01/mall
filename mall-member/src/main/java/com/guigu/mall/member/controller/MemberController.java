package com.guigu.mall.member.controller;

import java.util.Arrays;
import java.util.Map;

import com.guigu.mall.member.feign.AlphaFeignService;
...
import com.guigu.mall.member.service.MemberService;
...
public class MemberController {
    ...
    @Autowired
    AlphaFeignService feignService;

    @RequestMapping("/coupons")
    public R test() {
        MemberEntity memberEntity = new MemberEntity();
        memberEntity.setNickname("王66");
